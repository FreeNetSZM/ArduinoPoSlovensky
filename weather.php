<?php
        ...
        $lang = 'sk'; // Can be set to 'en', 'de', 'pl', 'es', 'fr', 'it', 'tet' or 'x-pig-latin' (see forecast.io API); default is 'en'
        if($unitsParam != "") { $units = $unitsParam;   }
        ...
        echo iconv("UTF-8", "CP1250//TRANSLIT", "CURRENT_SUMMARY=".$condition->getSummary()."\n" );
        ...
        echo iconv("UTF-8", "CP1250//TRANSLIT", "SUMMARY_TODAY=".$conditions_week[0]->getSummary()."\n" );
        ...
        echo iconv("UTF-8", "CP1250//TRANSLIT", "SUMMARY_TOMORROW=".$conditions_week[1]->getSummary()."\n" );
