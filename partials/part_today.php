<div class="col-md-6 col-sm-6">
  ...
  ?>
    <div class="panel panel-default">
      <div class="panel-heading"><h3 class="no-margin"><strong>Dnešná predpoveď</strong> <small class="text-warning hidden-sm hidden-xs"><?php echo date("d.m.Y", $tTime); ?></small></h3></div>
      <div class="panel-body">
              ...
              <i class="wi wi-strong-wind"></i> <?php echo $tWindSpeed; ?> km/h 
                        <?php
