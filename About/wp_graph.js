// set your channel id here
  ...
  function initChartTeplota() {
    ...
    options = {width: 220, height: 220, min: -10, max: 45, redFrom: 35, redTo: 45, yellowFrom: -10, yellowTo: 0, minorTicks: 5};
  ...
  function initChartVlhkost() {
    ...
    options = {width: 220, height: 220, min: 20, max: 80, greenFrom: 40, greenTo: 60, minorTicks: 10};
  ...
  function initChartTlak() {
    ...
    options = {width: 220, height: 220, min: 980, max: 1050, redFrom: 980, redTo: 1000, yellowFrom: 1030, yellowTo: 1050, greenFrom: 1000, greenTo: 1030, minorTicks: 5};
  ...
  function initChartLux() {
    ...
    options = {width: 220, height: 220, min: 0, max: 200, minorTicks: 5};
    displayData(lux, "Lux");
  }     
